...
- [ ] **Step 1: Create send_telegram_message.py**
...
- [ ] **Step 2: Create send_telegram_photo.py**
...
- [ ] **Step 3: Create send_telegram_video.py**
...
- [ ] **Step 1: Create download_video.py**
...
- [ ] **Step 2: Create generate_image.py (HuggingFace)**
...
- [ ] **Step 1: Create route_command.sh**
...
- [ ] **Step 1: Create telegram-bot.yml**
...
- [ ] **Step 2: Verify all scripts are valid**
